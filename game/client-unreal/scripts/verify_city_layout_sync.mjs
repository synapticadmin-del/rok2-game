...
const required = [
  ...
  ['apiHeader', /SaveCityLayout\(const TArray<FRok2CityLayoutPlacement>& Placements\)/, 'واجهة طلب حفظ التخطيط'],
  ...
  ['layoutActor', /Api->SaveCityLayout\(Payload\)/, 'ربط محرر القلعة بالحفظ السلطوي'],
