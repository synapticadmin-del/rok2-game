 ...
 *
 * الترتيب مقصود: تعليقات **السطر أولاً** ثم الكتل. العكس كان عطلاً كامناً —
 * تعليق سطر يحتوي على فاتحة كتلة (مثل المسار `/Engine/BasicShapes/` متبوعاً
 * بنجمة في Rok2Perf.h:4) يفتح كتلة وهمية تُغلق عند أول خاتمة كتلة بعده، فتُمحى
 * عشرات الأسطر من الكود الحقيقي بينهما ويصير السكربت يفحص فراغاً — أي **نجاح
 * كاذب** صامت. يحرس هذا الترتيبَ اختبار النفي في verify_compile_risks.mjs.
 */
