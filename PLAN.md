...
- [ ] **P1-T2** Client: شاشة تحميل + إعادة اتصال تلقائي + معالجة أخطاء الشبكة في `URok2Api`
...
|---------|-------|--------|---------|
| 2026-07-28 | إنشاء PLAN.md + تحديث التوثيق الجذري | — | البداية الرسمية للخطة التنفيذية |
