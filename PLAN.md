...
>
> **آخر تحديث:** 2026-07-29 — P4-T7 تحسين أداء UA: URok2Perf subsystem (خبأ meshes + مسبح actors + LOD موحد) + إعادة تدوير المباني في CityLayout + تلال ثابتة بمفتاح محتوى في WorldRenderer.
