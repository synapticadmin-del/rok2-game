...
| 2026-07-28 | P3-T5 توثيق خطة Soft launch التشغيلية | COMMIT_HASH | game/docs/SOFT_LAUNCH.md جديد: تهيئة ممالك من softlaunch.json + خطوات wrangler deploy مع migrations 0005/0006 + التحقق عبر /v1/launch/status و/v1/admin/retention + قراءة cohorts مقابل العتبات + runbook يومي + حدود معروفة (التتبع من تاريخ النشر، قياس معزول لكل worker) |
---
